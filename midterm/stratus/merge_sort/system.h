...
#include "defines.h"
#include "tb.h"
#include "MergeSort_wrap.h"		// use the generated wrapper for all hls_modules
...
SC_MODULE( System )
{
	...
	MergeSort_wrapper	*m_MergeSort;		// use the generated wrapper for the MergeSort hls module
	tb		*m_tb;
	...
	, chan2( "chan2" )
	{
		...
		m_MergeSort = new MergeSort_wrapper( "MergeSort_wrapper" );
		m_MergeSort->clk( clk_sig );
		m_MergeSort->rst( rst_sig );
		m_MergeSort->din( chan1 );
		m_MergeSort->dout( chan2 );
