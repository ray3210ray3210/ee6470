...
public:
	...
	addr_t MergeLV2_p0_start_addr = 0x75000000;
 	addr_t MergeLV2_p0_size = 0x01000000;
 	addr_t MergeLV2_p0_end_addr = MergeLV1_p0_start_addr + MergeLV1_p0_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > MergeLV1_p1_end_addr) &&
