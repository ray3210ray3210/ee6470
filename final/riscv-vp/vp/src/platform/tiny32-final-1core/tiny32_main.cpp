...
public:
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > MergeLV1_p0_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	MergeLV1_p0 merge_Sort("merge_Sort");
	...
	bus.isocks[10].bind(merge_Sort.tsock);
