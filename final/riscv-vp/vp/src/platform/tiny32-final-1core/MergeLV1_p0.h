#ifndef MERGE_LV1_P0_H
#define MERGE_LV1_p0_H
#include <systemc>
#include <cmath>
#include <iomanip>
...
struct MergeLV1_p0 : public sc_module {
  tlm_utils::simple_target_socket<MergeLV1_p0> tsock;
...
//     //---FIFO OUT---
  sc_fifo<unsigned int> o_data_lv1_p0;
//   sc_fifo<unsigned char> o_data_lv1_p0_size0;
//   sc_fifo<unsigned char> o_data_lv1_p0_size1;
//   sc_fifo<unsigned char> o_data_lv1_p0_size2;
//   sc_fifo<unsigned char> o_data_lv1_p0_size3;

  SC_HAS_PROCESS(MergeLV1_p0);

  MergeLV1_p0(sc_module_name n): 
    sc_module(n), 
    tsock("t_skt"), 
    base_offset(0) 
  {
    tsock.register_b_transport(this, &MergeLV1_p0::blocking_transport);
    SC_THREAD(merge_lv1_p0);
  }
      ...
      case tlm::TLM_READ_COMMAND:
        ...
        switch (addr) {
          case MERGE_SORT_RESULT_ADDR:
            buffer.uint = o_data_lv1_p0.read();
