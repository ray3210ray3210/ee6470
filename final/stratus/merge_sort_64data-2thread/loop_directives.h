...
#ifndef _LOOP_DIRECTIVES_H_
#define _LOOP_DIRECTIVES_H_
...
#ifdef UNROLL_FILL
#   define FIRST_LOOP   HLS_UNROLL_LOOP( ON, "first loop" )
#   define SECOND_LOOP  HLS_UNROLL_LOOP( ON, "second loop" )
#   define THIRD_LOOP   HLS_UNROLL_LOOP( ON, "third loop" )
#   define FOURTH_LOOP  HLS_UNROLL_LOOP( ON, "fourth loop" )
#endif
