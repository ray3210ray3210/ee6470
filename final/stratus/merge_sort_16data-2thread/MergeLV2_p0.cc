...
void MergeLV2_p0::merge_lv2_p0()
{
	...
	while( true )
	{
		...
		for(int n=0 ; n<DATA_NUM_L1 ; n++)
        {
			...
			input_t in_val_p0 = i_data_lv1_p0.get();
			input_t in_val_p1 = i_data_lv1_p1.get();
			sort_array[n] = in_val_p0;
			sort_array[n+DATA_NUM_L1] = in_val_p1;
            wait();
		}
