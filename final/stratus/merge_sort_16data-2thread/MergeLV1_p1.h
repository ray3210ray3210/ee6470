...
SC_MODULE( MergeLV1_p1 )
{
	...
	cynw_p2p < input_t >::in	i_data_lv0_p1;	// The input port
	cynw_p2p < output_t >::out	o_data_lv1_p1;	// The output port
	...
	: clk( "clk" )
	, rst( "rst" )
	, i_data_lv0_p1( "i_data_lv0_p1" )
	, o_data_lv1_p1( "o_data_lv1_p1" )
	{
#if defined(FLAT)
...
#endif
		SC_CTHREAD( merge_lv1_p1, clk.pos() );
		reset_signal_is( rst, 0 );
		// Connect the P2P ports to clk and rst
		i_data_lv0_p1.clk_rst( clk, rst );
		o_data_lv1_p1.clk_rst( clk, rst );
	}
	...
	void merge_lv1_p1();	// the thread function
