...
#define MERGE_LV1_EIGHT_p0_H

#include <cynw_p2p.h>
#include "defines.h"

SC_MODULE( MergeLV1_p0 )
{
	...
	cynw_p2p < input_t >::in	i_data_lv0_p0;	// The input port
	cynw_p2p < output_t >::out	o_data_lv1_p0;	// The output port
	...
	: clk( "clk" )
	, rst( "rst" )
	, i_data_lv0_p0( "i_data_lv0_p0" )
	, o_data_lv1_p0( "o_data_lv1_p0" )
	{
#if defined(FLAT)
...
#endif
		SC_CTHREAD( merge_lv1_p0, clk.pos() );
		reset_signal_is( rst, 0 );
		// Connect the P2P ports to clk and rst
		i_data_lv0_p0.clk_rst( clk, rst );
		o_data_lv1_p0.clk_rst( clk, rst );
	}
	...
	void merge_lv1_p0();	// the thread function
