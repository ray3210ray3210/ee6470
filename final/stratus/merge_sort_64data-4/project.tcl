...
define_hls_module	MergeLV1_p2	MergeLV1_p2.cc		;# SystemC module to be synthesized
define_hls_module	MergeLV1_p3	MergeLV1_p3.cc		;# SystemC module to be synthesized
define_hls_module	MergeLV2_p0	MergeLV2_p0.cc		;# SystemC module to be synthesized
define_hls_module	MergeLV2_p1	MergeLV2_p1.cc		;# SystemC module to be synthesized
define_hls_module	MergeLV3_p0	MergeLV3_p0.cc		;# SystemC module to be synthesized
#define_hls_module	MergeSort	MergeSort.cc		;# SystemC module to be synthesized

#
# Synthesis Configurations
#
define_hls_config	Partition	UNROLL		--unroll_loops=on		;# A synthesis configuration of the hls_module
...
define_hls_config	MergeLV1_p2	UNROLL		--unroll_loops=on
define_hls_config	MergeLV1_p2	FLAT        --flatten_arrays=all

define_hls_config	MergeLV1_p3	UNROLL		--unroll_loops=on
define_hls_config	MergeLV1_p3	FLAT        --flatten_arrays=all
#---LV2
define_hls_config	MergeLV2_p0	UNROLL		--unroll_loops=on
define_hls_config	MergeLV2_p0	FLAT        --flatten_arrays=all

define_hls_config	MergeLV2_p1	UNROLL		--unroll_loops=on
define_hls_config	MergeLV2_p1	FLAT        --flatten_arrays=all
#---LV3
define_hls_config	MergeLV3_p0	UNROLL		--unroll_loops=on
define_hls_config	MergeLV3_p0	FLAT        --flatten_arrays=all
...
foreach cfg { UNROLL FLAT} {
	define_sim_config V_${cfg} \
	"Partition RTL_V ${cfg}" \
	"MergeLV1_p0 RTL_V ${cfg}" \
	"MergeLV1_p1 RTL_V ${cfg}" \
	"MergeLV1_p2 RTL_V ${cfg}" \
	"MergeLV1_p3 RTL_V ${cfg}" \
	"MergeLV2_p0 RTL_V ${cfg}" \
	"MergeLV2_p1 RTL_V ${cfg}" \
	"MergeLV3_p0 RTL_V ${cfg}" \
}
