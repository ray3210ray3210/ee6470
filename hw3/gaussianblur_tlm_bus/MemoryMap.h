...
// GaussianBlur filter Memory Map
// Used between SimpleBus & GaussianBlurFilter
const int GAUSSIANBLUR_MM_BASE = 0x90000000;
const int GAUSSIANBLUR_MM_SIZE = 0x0000000C;
const int GAUSSIANBLUR_MM_MASK = 0x0000000F;
